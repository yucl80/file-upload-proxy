 ...
 */
//@Service
public class HttpRequestProxyServiceHttpClientImpl implements HttpRequestProxyService {
    private static final Logger logger = LoggerFactory.getLogger(HttpRequestProxyServiceHttpClientImpl.class);
    ...
    public HttpRequestProxyServiceHttpClientImpl() {
        try {
